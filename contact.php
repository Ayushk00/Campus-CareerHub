...
<body>
    ...
    <section id="contact" class="contact">
        ...
        <iframe src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Jhalwa,%20Allahabad%20+(IIIT%20Allahabad)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div><!-- End Google Maps -->
        ...
        <div class="container">
            ...
            <div class="row gy-5 gx-lg-5">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="info">
                        <h3>Get in touch</h3>
                        <p>CAMPUS CAREERHUB</p>

                        <div class="info-item d-flex">
                            <i class="bi bi-geo-alt flex-shrink-0"></i>
                            <div>
                                <h4>Location:</h4>
                                <p>Indian Institute of Information Technology, Allahabad, Jhalwa, Prayagraj Uttar Pradesh 211012.</p>
                            </div>
                        </div><!-- End Info Item -->
