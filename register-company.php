  ...
  <div class="wrapper">
            ...
            <form method="post" id="registerCompanies" action="addcompany.php" enctype="multipart/form-data">
              <div class="col-md-6 latest-job ">
                <div class="form-group">
                  <input class="form-control input-lg" type="text" name="name" placeholder="Full Name (company)" required>
                </div>
                <div class="form-group">
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2024 <a href="https://www.iiita.ac.in">Campus CareerHub</a>.</strong> All rights
        reserved.
      </div>
    </footer>
